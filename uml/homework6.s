...
main:
	addi	$sp, $sp, -4		#
	sw	$ra, 0($sp)		# Uses stackpointer $sp to keep track of navigation
...
PRINT_1_EMP:
	...
	la 	$a0, tab3		# Load address of "tab3"
	jal 	PRINT_STR		# Jump to "PRINT_STR" and link
...
FOR:	
	...
	jal 	PRINT_STR		# Jump to "PRINT_STR" and link
        ...
        move 	$a0, $s1           	# Prepares for output
	jal 	PRINT_INT
...
END_FOR: 		
	...
	jal	PRINT_STR		#
        ...
        move	$a0, $s7		# Prepares for output
